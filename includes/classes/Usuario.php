...
class Usuario {
    ...
    public function esAmigo($usuario_a_verificar)
    {
        ...
        if ((strstr($this->usuario['lista_amigos'], $usuario_a_verificar)) || $usuario_a_verificar == $this->usuario['username'])
        {
            return true;
        }
        else
    ...
    {
        $nombre_usuario = "," . $usuario_a_verificar . ",";
        if ((strstr($this->usuario['lista_seguidos'], $usuario_a_verificar)) || $usuario_a_verificar == $this->usuario['username'])
        {
            return true;
        }
        else
    ...
    public function eliminarAmigo($usuario_a_remover)
    {
        ...
        $query_obtener_lista_amigos = mysqli_query($this->con, "SELECT username, lista_amigos FROM usuarios WHERE id_usuario='$usuario_a_remover'");
        ...
        $nombre_usuario_a_remover = $fila['username'];

        // + Removemos al amigo del usuario loggeado
        $nueva_lista_de_amigos_usuario_loggeado = str_replace($nombre_usuario_a_remover . ",", "", $this->usuario['lista_amigos']);
        ...
        $nueva_lista_de_amigos_usuario_removido = str_replace($this->usuario['username'] . ",", "", $usuario_lista_amigos);
    ...
    public function dejarSeguir($usuario_a_remover)
    {
        ...
        $query_obtener_arreglo_seguidores = mysqli_query($this->con, "SELECT username, lista_seguidores FROM usuarios WHERE id_usuario='$usuario_a_remover'");
        ...
        $nueva_lista_seguidos_usuario_loggeado = str_replace($nombre_usuario_a_remover . ",", "", $this->usuario['lista_seguidos']);
        ...
        $nueva_lista_seguidores_usuario_removido = str_replace($this->usuario['username'] . ",", "", $usuario_lista_seguidores);
    ...
    public function seguirUsuario($usuario_solicitado)
    {
        ...
        $seguidor = $this->usuario['username'];

        // + Query para obtener el id_usuario, el nombre de usuario y la lista de seguidos del usuario que se solicito seguir
        $query_seleccionar_seguido = mysqli_query($this->con, "SELECT id_usuario, username FROM usuarios WHERE id_usuario = $usuario_solicitado");
        $fila = mysqli_fetch_array($query_seleccionar_seguido);

        $id_seguido = $fila['id_usuario'];
        $seguido = $fila['username'];

        $query_agregar_seguido = mysqli_query($this->con, "UPDATE usuarios SET lista_seguidos=CONCAT(lista_seguidos, '$seguido,') WHERE id_usuario='$id_seguidor'");
        $query_agregar_seguidor = mysqli_query($this->con, "UPDATE usuarios SET lista_seguidores=CONCAT(lista_seguidores, '$seguidor,') WHERE id_usuario='$id_seguido'");
        ...
        foreach($lista_seguidores_seguidor_explode as $seguidor)
        {
            if($seguidor == $seguido)
            {
        ...
        {         
            // + Removemos al seguido
            $nueva_lista_seguidos_usuario_loggeado = str_replace($seguido . ",", "", $this->usuario['lista_seguidos']);
            ...
            $nueva_lista_seguidores_usuario_loggeado = str_replace($seguido . ",", "", $this->usuario['lista_seguidores']);
            ...
            // + Removemos al seguidor
            $nueva_lista_seguidos_usuario_seguido = str_replace($this->usuario['username'] . ",", "", $lista_seguidos_seguido);
            ...
            $nueva_lista_seguidores_usuario_seguido = str_replace($this->usuario['username'] . ",", "", $lista_seguidores_seguido);
            ...
            $query_agregar_amigo = mysqli_query($this->con, "UPDATE usuarios SET lista_amigos=CONCAT(lista_amigos, '$seguidor,') WHERE id_usuario='$id_seguido'");
            $query_agregar_amigo = mysqli_query($this->con, "UPDATE usuarios SET lista_amigos=CONCAT(lista_amigos, '$seguido,') WHERE id_usuario='$id_seguidor'");
