...
if((isset($_POST['publicar_titulo'])) && isset($_POST['publicar_texto'])) {
    ...
    if($subida_exitosa == 1)
    {
        ...
        $tipo_pagina = "pagina";
        $publicacion->enviarPublicacion($_POST['publicar_titulo'], $_POST['publicar_texto'], $_POST['publicado_para'], $nombres_imagenes, $nombres_archivos, $id_proyecto, $tipo_pagina, "");
