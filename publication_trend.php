...
{
    echo "No existe ninguna publicación con este trend";
}

?>

    <div class="columna_principal">
        <div class="cuerpo_trend">
            ...
            $(function() {
                ...
                function cargarPosts() {
                    ...
                    $.ajax({
                        ...
                        url: "includes/handlers/ajax_load_trend_posts.php",
                        type: "POST",
                        // + Esto es lo que se manda a la pagina
                        // + ESTA ES LA REQUEST AL AJAX_LOAD_POSTS ES LO QUE TENDRA DENTRO REQUEST
                        data: "pagina=" + pagina + "&id_usuario_loggeado=" + id_usuario_loggeado + "&trend=" + trend,
                        cache: false,
